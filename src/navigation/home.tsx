...
export const homeNavigator = createBottomTabNavigator({
  ...
  Movement:   { screen: MovementScreen, 
                ...
                tabBarLabel: i18n.t('navigation.movement')}
              },
  Charts:     { screen: ChartScreen, 
                navigationOptions: {tabBarIcon: <Icon name="show-chart"></Icon>, 
                tabBarLabel: i18n.t('navigation.charts')}
              },
  Settings:   { screen: SettingsScreen, 
                navigationOptions: {tabBarIcon: <Icon name="settings"></Icon>, 
